...
integrated.sr.sctypeDB <- find_cellTypes(integrated.sr.filepath, "Integrated Short Reads - scTypeDB")
integrated.sr.panglaoDB <- find_cellTypes(integrated.sr.filepath, "Integrated Short Reads - PanglaoDB", usePanglaoDB = TRUE)
generate_PDFs(integrated.sr.sctypeDB, integrated.sr.panglaoDB,
              filePrefix = "Integrated_ShortReads", sampleDescription = "INTEGRATED SHORT READS")
integrated.lr.sctypeDB <- find_cellTypes(integrated.lr.filepath, "Integrated Long Reads - scTypeDB", longRead = TRUE)
integrated.lr.panglaoDB <- find_cellTypes(integrated.lr.filepath, "Integrated Long Reads - PanglaoDB", longRead = TRUE, usePanglaoDB = TRUE)
generate_PDFs(integrated.lr.sctype, integrated.lr.panglaoDB,
              filePrefix = "Integrated_LongReads", sampleDescription = "INTEGRATED LONG READS")
...
generateGeneMarkerPlots(seurat.obj.integratedSR, "Integrated-SR")
generateGeneMarkerPlots(seurat.obj.integratedLR, "Integrated-LR", longRead = TRUE)
...
generateGeneMarkerPlots.v2(seurat.obj.integratedLR, "Integrated-LR", longRead = TRUE)

Neuronal.differentiation.markers <- list(c("ASCL1", "CD24", "CDH2", "EPCAM",
                                           "ITGB1", "L1CAM", "MAP2",
                                           "MCAM", "NEUROG2", "SATB2",
                                           "SOX5", "TUBB3"))
neuron.diff.marker.plt <- FeatureSetPlot(seurat.obj.integratedSR, Neuronal.differentiation.markers, "neuron_diff") +
...
neural.progenitor.marker.plt <- FeatureSetPlot(seurat.obj.integratedSR, neuronal.progenitor.cell.markers, "neuron.progenitor") +
...
saveRDS(seurat.obj.integratedLR, file = "Relabeled_LR_days25+55-script3.rds")
saveRDS(seurat.obj.integratedSR, file = "Relabeled_SR_days25+55-script3.rds")
